...
- **多节点**：First Commit 纪念碑、开源之墙、Fork 广场等公共空间节点
...
1. **资料合法性**：所有引用资料来自公开来源或用户清权资料 [source:SRC-AGENT-TASKBOOK]
2. **版权授权**：本方案采用 COMMUNITY-DISPLAY-ONLY 许可
3. **非公开资料排除**：未使用非公开政府数据、企业内部数据或个人隐私数据
4. **隐私保护**：AI 场景卡均标注隐私边界和人工复核机制
5. **官方批准禁用**：所有空间建议为概念建议，不构成政府审定结论
6. **待补资料**：官方精确红线、控规条件、现状建筑数据、权属数据
7. **专业复核需求**：需由城市规划、交通、市政、文保、法务等专业团队深化确认
